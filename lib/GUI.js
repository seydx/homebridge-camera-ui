...
class GUI {
  ...
  createExpress(){
    ...
    const indexRouter = require('./routes/index')(this.accessory.displayName, this.WEBSOCKET_PORT);
  ...
  spawnCamera(){
    ...
    if(!this.ffmpeg){
      ...
      debug(this.accessory.displayName + ': Spawning camera...')
    ...
    setTimeout(this.spawnCamera.bind(this), 30000);
